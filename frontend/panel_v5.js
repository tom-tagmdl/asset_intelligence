...
class AssetIntelligenceApp extends HTMLElement {
  ...
  _getDefaultLabelIds() {
    ...
    const defaultLabels = attrs.default_label_ids;

    if (Array.isArray(defaultLabels)) {
      return defaultLabels.filter((labelId) => typeof labelId === "string" && labelId.trim());
    }

    const systemDefaults = attrs.system_defaults;
    if (systemDefaults && Array.isArray(systemDefaults.default_label_ids)) {
      return systemDefaults.default_label_ids.filter(
        (labelId) => typeof labelId === "string" && labelId.trim()
      );
    }
    ...
    return `
      <div class="ai-card ai-asset-click">
        <div class="ai-card-top ${imageUrl ? "has-image" : ""}" ${
          ...
          <ha-icon icon="${this._escapeHtml(icon)}" style="width:40px;height:40px; color: var(--secondary-text-color); opacity: ${imageUrl ? "0.22" : "0.6"}; position: relative; z-index: 1;"></ha-icon>
        </div>
        <div class="ai-card-body">
    ...
    return `
      <div class="ai-card ai-room-asset-card ai-asset-click" data-asset="${this._escapeHtml(attrs.asset_id)}">
        <div class="ai-card-top ${imageUrl ? "has-image" : ""}" ${
          ...
          <div class="ai-icon-wrap" style="opacity:${imageUrl ? "0.28" : "1"};">
            <ha-icon icon="${this._escapeHtml(icon)}"></ha-icon>
          </div>
        </div>
          ...
          <div class="ai-asset-header-main">
            <div
              ...
              ${imageUrl
                ...
                : ""}
            >
              <ha-icon icon="${this._escapeHtml(effectiveIcon)}" style="opacity:${imageUrl ? "0.2" : "0.7"};"></ha-icon>
            </div>
